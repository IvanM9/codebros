...
const ViewProject = ({ projects }) => {
  ...
  return (
    <>
    <p className='absolute top-16 lg:top-5 text-2xl font-bold text-gray-900 mb-10'>Todos los proyectos</p>
    <div className="w-full grid grid-cols-responsive gap-5 mt-20">
      {projects.map(project =>(
        <div key={project.id} className='mx-auto max-w-lg rounded-lg border border-stone bg-gray-200 p-4 shadow-lg sm:p-6 lg:p-8'>
        <h2 className='text-gray-900 text-xl font-bold mb-2'>{project.name}</h2>
